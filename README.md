...
> El programa guía paso a paso. No guarda una lista de contenidos, solo evalua cada propuesta y los datos se mantienen para estadísticas generales.
...
2. Abre la solución en Visual Studio o cualquier editor con C#.
